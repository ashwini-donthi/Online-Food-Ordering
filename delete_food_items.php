...
?>
  ...
  <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
    ...
    <li><a href="delete_food_items.php" class="dropdown-item active ">Delete Food Items</a></li>
...
$sql = "SELECT * FROM food f WHERE f.options = 'ENABLE' AND f.R_ID  ORDER BY F_ID";
